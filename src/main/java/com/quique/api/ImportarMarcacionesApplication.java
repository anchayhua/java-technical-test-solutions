...
//@PropertySource(value = {"file:/opt/env-sb-importarmarcaciones/application.properties"})
public class ImportarMarcacionesApplication {

    @Autowired
    private Environment env;

    public static void main(String[] args) {
        SpringApplication.run(ImportarMarcacionesApplication.class, args);
    }
    ...
    public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
        ...
        factoryBean.setPackagesToScan(new String[]{"com.quique.api.model"});
